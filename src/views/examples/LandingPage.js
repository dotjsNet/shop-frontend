              ...
              <Col lg="6" md="6">
                ...
                <div className="btn-wrapper mb-3">
                  ...
                  <Button
                    ...
                    size="sm"
                  >
                    <i className="jay-icons icon-minimal-right" />
                  </Button>
                </div>
              ...
              <Row className="row-grid justify-content-between">
                          ...
                          <Row>
                            <Col md="4" xs="5">
                              <div className="icon-big text-center icon-warning">
                                <i className="jay-icons icon-trophy text-warning" />
                              </div>
                            </Col>
                            <Col md="8" xs="7">
                      ...
                      <Card className="card-stats upper bg-default">
                        <CardBody>
                          <Row>
                            <Col md="4" xs="5">
                              <div className="icon-big text-center icon-warning">
                                <i className="jay-icons icon-coins text-white" />
                              </div>
                            </Col>
                            <Col md="8" xs="7">
                              <div className="numbers">
                      ...
                      <Card className="card-stats">
                        <CardBody>
                          <Row>
                            <Col md="4" xs="5">
                              <div className="icon-big text-center icon-warning">
                                <i className="jay-icons icon-gift-2 text-info" />
                              </div>
                            </Col>
                            <Col md="8" xs="7">
                              <div className="numbers">
                      ...
                      <Card className="card-stats">
                        <CardBody>
                          <Row>
                            <Col md="4" xs="5">
                              <div className="icon-big text-center icon-warning">
                                <i className="jay-icons icon-credit-card text-success" />
                              </div>
                            </Col>
                            <Col md="8" xs="7">
                              <div className="numbers">
                ...
                <Col md="6">
                  <div className="pl-md-5">
                    ...
                    >
                      Show all{" "}
                      <i className="jay-icons icon-minimal-right text-info" />
                    </a>
                  </div>
                </Col>
              </Row>
                  ...
                  <Col lg="3">
                    <div className="info">
                      <div className="icon icon-primary">
                        <i className="jay-icons icon-money-coins" />
                      </div>
                  ...
                  <Col lg="3">
                    <div className="info">
                      <div className="icon icon-warning">
                        <i className="jay-icons icon-chart-pie-36" />
                      </div>
                ...
                <div className="px-md-5">
                  ...
                  <ul className="list-unstyled mt-5">
                    <li className="py-2">
                      <div className="d-flex align-items-center">
                        <div className="icon icon-success mb-2">
                          <i className="jay-icons icon-vector" />
                        </div>
                        <div className="ml-3">
                    ...
                    <li className="py-2">
                      <div className="d-flex align-items-center">
                        <div className="icon icon-success mb-2">
                          <i className="jay-icons icon-tap-02" />
                        </div>
                        <div className="ml-3">
