        ...
        <div className="blur-hover">
          <a href="https://demos.creative-tim.com/blk-design-system-react/#/documentation/icons">
            <div className="icons-container blur-item on-screen mt-5">
              {/* Center */}
              <i className="icon jay-icons icon-coins" />
              {/* Right 1 */}
              <i className="icon icon-sm jay-icons icon-spaceship" />
              <i className="icon icon-sm jay-icons icon-money-coins" />
              <i className="icon icon-sm jay-icons icon-link-72" />
              {/* Right 2 */}
              <i className="icon jay-icons icon-send" />
              <i className="icon jay-icons icon-mobile" />
              <i className="icon jay-icons icon-wifi" />
              {/* Left 1 */}
              <i className="icon icon-sm jay-icons icon-key-25" />
              <i className="icon icon-sm jay-icons icon-atom" />
              <i className="icon icon-sm jay-icons icon-satisfied" />
              {/* Left 2 */}
              <i className="icon jay-icons icon-gift-2" />
              <i className="icon jay-icons icon-tap-02" />
              <i className="icon jay-icons icon-wallet-43" />
            </div>
