    ...
    <div className="section section-notifications" id="notifications">
      <Container>
        ...
        <UncontrolledAlert className="alert-with-icon" color="primary">
          <span data-notify="icon" className="jay-icons icon-coins" />
          <span>
            <b>Congrats! -</b>
        ...
        <UncontrolledAlert className="alert-with-icon" color="info">
          <span data-notify="icon" className="jay-icons icon-trophy" />
          <span>
            <b>Heads up! -</b>
        ...
        <UncontrolledAlert className="alert-with-icon" color="success">
          <span data-notify="icon" className="jay-icons icon-bell-55" />
          <span>
            <b>Well done! -</b>
        ...
        <UncontrolledAlert className="alert-with-icon" color="warning">
          <span data-notify="icon" className="jay-icons icon-bulb-63" />
          <span>
            <b>Warning! -</b>
        ...
        <UncontrolledAlert className="alert-with-icon" color="danger">
          <span data-notify="icon" className="jay-icons icon-support-17" />
          <span>
            <b>Oh snap! -</b>
